...
module Treasury
  class Stash
    ...
    # if not, this will raise a Treasury::Storage::Unidentified exception
    ...
    def put(object)
      if object.is_a? Array
        ...
        raise Treasury::Storage::Unidentified, "you can't stash an object without a key" unless key
        @data[key] = object
      end
    end
